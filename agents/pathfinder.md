---
name: pathfinder
description: Use to investigate a bounded question across code, documents, Jira, Confluence, and Snowflake, and return a compressed structured briefing — direct answers, per-source findings, coverage, confidence, assumptions, and open questions. Read-only and designed for parallel spawning across sources.
