...
1. **Invoke the `structure-review` skill** for the review end-to-end — scoping, reading declarations before source, the seven passes, the leverage tiers, the report. The skill is the single source of truth for the method; do not duplicate or reinterpret it here.
