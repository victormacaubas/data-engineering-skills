...
|---|---|---|
| `python-code-reviewer` | `code-reviewer` | Superseded by the language-agnostic `code-reviewer` skill. Python-specific footguns live in `code-audit/languages/python.md`. |
